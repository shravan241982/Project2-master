		...
		<div class="nam-matis">
			<div class="nam-matis-top">
						<div class="col-md-6 nam-matis-1">
							<a href="single.html"><img src="<c:url value="/resources/images/5.jpg" />" class="img-responsive" alt=""></a>
						...
						<div class="col-md-6 nam-matis-1">
							<a href=""><img src="<c:url value="/resources/images/6.jpg" />" class="img-responsive" alt=""></a>
				...
				<div class="nam-matis-top">
						<div class="col-md-6 nam-matis-1">
							<a href="single.html"><img src="<c:url value="/resources/images/4.jpg" />" class="img-responsive" alt=""></a>
							<h3><a href="single.html">Suspendisse a pellentesque dui</a></h3>
							<p>Etiam ullamcorper. Suspendisse a pellentesque dui, non felis. Maecenas malesuada elit lectus felis, malesuada ultricies. Curabitur et ligula.</p>
						</div>
						<div class="col-md-6 nam-matis-1">
							<a href="single.html"><img src="<c:url value="/resources/images/1.jpg" />" class="img-responsive" alt=""></a>
							<h3><a href="single.html">Suspendisse a pellentesque dui</a></h3>
							<p>Etiam ullamcorper. Suspendisse a pellentesque dui, non felis. Maecenas malesuada elit lectus felis, malesuada ultricies. Curabitur et ligula.</p>
						</div>
							<div class="clearfix"> </div>
		...
		<div class="blo-top">
			<div class="blog-grids">
				<div class="blog-grid-left">
					<a href="single.html"><img src="<c:url value="/resources/images/1b.jpg" />" class="img-responsive" alt=""></a>
				</div>
			...
			<div class="blog-grids">
				<div class="blog-grid-left">
					<a href="single.html"><img src="<c:url value="/resources/images/2b.jpg" />" class="img-responsive" alt=""></a>
				</div>
			...
			<div class="blog-grids">
				<div class="blog-grid-left">
					<a href=""><img src="<c:url value="/resources/images/3b.jpg" />" class="img-responsive" alt=""></a>
				</div>
				<div class="blog-grid-right">
					<h4><a href="single.html">Little Invaders </a></h4>
					<p>pellentesque dui, non felis. Maecenas male </p>
